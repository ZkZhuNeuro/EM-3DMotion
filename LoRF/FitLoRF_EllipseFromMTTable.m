...
inputMat = 'C:\Users\zzhu329\Documents\GitHub\EM-3DMotion\LoRF\LoRF_unit_table_jim_mt.mat';
outputMat = 'C:\Users\zzhu329\Documents\GitHub\EM-3DMotion\LoRF\LoRF_unit_table_jim_mt_with_ellipse.mat';
plotDir = 'C:\LoData\RF\EllipseFitPreview_MT';
logFile = 'C:\LoData\RF\FitLoRF_EllipseFromMTTable.log';
...
paperFilter = loadPaperNeuronFilterFromStruct(paperTablePath, 'Jim');
paperMatchedRowIndices = findPaperMatchingUnits(RF_table, paperFilter, 'Jim');

logMessage(logFile, 'Paper-matched Jim units selected for fitting: %d/%d', ...
...
logMessage(logFile, 'Jim RF_table trimmed to %d paper-matched rows.', height(RF_table));

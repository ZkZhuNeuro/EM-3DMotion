...
if ~exist('inputMat', 'var') || isempty(inputMat)
    inputMat = 'C:\Users\zzhu329\Documents\GitHub\EM-3DMotion\LoRF\LoRF_unit_table_clay_mt.mat';
end
if ~exist('outputMat', 'var') || isempty(outputMat)
    outputMat = 'C:\LoData\RF\LoRF_unit_table_clay_mt_with_ellipse.mat';
end
if ~exist('plotDir', 'var') || isempty(plotDir)
    plotDir = 'C:\LoData\RF\EllipseFitPreview_MT_Clay';
end
if ~exist('logFile', 'var') || isempty(logFile)
    logFile = 'C:\LoData\RF\FitLoRF_EllipseFromClayMTTable.log';
end

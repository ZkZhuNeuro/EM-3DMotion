...
figurePath = fullfile(outputDir, 'LoRF_Ellipse68_PopulationCumulative_MT.png');
regressionFigurePath = fullfile(outputDir, 'LoRF_Ellipse68_HoleY_vs_Eccentricity_MT.png');
logFile = fullfile(outputDir, 'PlotLoRF_Ellipse68_PopulationAnalysis_MT.log');
...
title(axNew, sprintf('Jim MT 68%% ellipse fits | reach x=%g deg: %d/%d (%.1f%%)', ...

...
figurePath = fullfile(outputDir, 'LoRF_Ellipse90_PopulationCumulative.png');
regressionFigurePath = fullfile(outputDir, 'LoRF_Ellipse90_HoleY_vs_Eccentricity.png');
logFile = fullfile(outputDir, 'PlotLoRF_Ellipse90_PopulationAnalysis.log');
...
title(axNew, sprintf('90%% ellipse fits | reach x=%g deg: %d/%d (%.1f%%)', ...

...
% unit_table(88, :) = [];
% unit_table(141, :) = []; % The unit_table data don't match results in P drive! Reanalyze. 
%%
n_FST = 0;
for rec = 1:size(unit_table, 1)
    if unit_table.p_AI{rec}(2) < 0.05 && unit_table.p_AI{rec}(3) < 0.05 && strcmp(cell2mat(unit_table.ROI(rec)), 'FST')
        ...
        MIDTable.Delta_bias{:, n_FST} = unit_table.Delta_bias{rec};
        ...
        MIDTable.AP{n_FST} = unit_table.Hole(rec, 2);
...
%%
criteria = BiasTable_max.z2D3D < 0 & (BiasTable_max.Condition == 1 | BiasTable_max.Condition == 4) & BiasTable_max.AbsBias <= 2;
...
%%
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.AbsBias <= 2;
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI\n\n'])
...
%%
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 1 & BiasTable_max.AbsBias <= 2;
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI\n\n'])
...
%%
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 2 & BiasTable_max.AbsBias <= 2;
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI\n\n'])
lm_1 = fitlm(temp_table,'Bias ~ AI');
anova(lm_1)
...
%%
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 3 & BiasTable_max.AbsBias <= 2;
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI\n\n'])
lm_1 = fitlm(temp_table,'Bias ~ AI');
anova(lm_1)
...
%%
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 4 & BiasTable_max.AbsBias <= 2;
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI\n\n'])
lm_1 = fitlm(temp_table,'Bias ~ AI');
anova(lm_1)
...
% 
% %%
% criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 4;
% temp_table = BiasTable_max(criteria,:);
% fprintf(2,['\n\n', ' AI*OD\n\n'])
% lm_1 = fitlm(temp_table,'Bias ~ AI + AI:OD');
% anova(lm_1)
...
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 1 & BiasTable_max.Monkey == 2;
temp_table = BiasTable_max(criteria,:);
s = scatter(temp_table.AI, temp_table.Bias, 40, ...
            colorsteps(1, :), 'filled', 'd', 'MarkerEdgeColor',colorsteps(1, :),'LineWidth',1.5);
...
%% LSQ 2D Combine
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 2;
temp_table = BiasTable_max(criteria,:);
x = temp_table.AI;
y = temp_table.Bias;
w = temp_table.OD;
...
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 2 & BiasTable_max.Monkey == 2;
temp_table = BiasTable_max(criteria,:);
s = scatter(temp_table.AI, temp_table.Bias, 40, ...
            colorsteps(2, :), 'filled', 'd', 'MarkerEdgeColor',colorsteps(2, :),'LineWidth',1.5);
s.AlphaData = temp_table.OD;
...
%% LSQ 2D Stereo
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 3;
temp_table = BiasTable_max(criteria,:);
x = temp_table.AI;
y = temp_table.Bias;
w = temp_table.OD;
...
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 3 & BiasTable_max.Monkey == 2;
temp_table = BiasTable_max(criteria,:);
s = scatter(temp_table.AI, temp_table.Bias, 40, ...
            colorsteps(3, :), 'filled', 'd', 'MarkerEdgeColor',colorsteps(3, :),'LineWidth',1.5);
s.AlphaData = temp_table.OD;
...
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Condition == 4 & BiasTable_max.Monkey == 2;
temp_table = BiasTable_max(criteria,:);
s = scatter(temp_table.AI, temp_table.Bias, 40, ...
            colorsteps(4, :), 'filled', 'd', 'MarkerEdgeColor',colorsteps(4, :),'LineWidth',1.5);
s.AlphaData = temp_table.OD;

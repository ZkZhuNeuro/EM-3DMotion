...
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI*OD\n\n'])
lm_1 = fitlme(temp_table,'FlipBias ~ AI * OD + (1 + AI * OD|Monkey)');
anova(lm_1)
...
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI\n\n'])
lm_1 = fitlme(temp_table,'Bias ~ AI * Coded_Condition + (1 + AI * Coded_Condition|Monkey)');
anova(lm_1)
...
plot([-1, 1], [0, 0], 'k--')
plot([0, 0], [-3, 3], 'k--')
title('MT 3D neurons','fontsize',18)
xlabel('Asymmetry Index','fontsize',18)
ylabel('Delta Bias','fontsize',18)
axis square
xticks([-1, 0, 1])

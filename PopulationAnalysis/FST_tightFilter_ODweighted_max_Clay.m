...
%% 
criteria = BiasTable_max.z2D3D > 0 & (BiasTable_max.Condition == 1 | BiasTable_max.Condition == 4) & BiasTable_max.Monkey == 2;
...
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI*OD\n\n'])
lm_1 = fitlme(temp_table,'FlipBias ~ AI + AI:OD + (AI + AI:OD|Monkey)');
anova(lm_1)

%% 
criteria = BiasTable_max.z2D3D < 0 & BiasTable_max.Monkey == 2;
temp_table = BiasTable_max(criteria,:);
fprintf(2,['\n\n', ' AI*OD\n\n'])
lm_1 = fitlm(temp_table,'FlipBias ~ AI + AI:OD');
anova(lm_1)

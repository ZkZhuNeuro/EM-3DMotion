clear;
load("C:\EM\BehaviorFitting\unit_table_lapseCap.mat")
...
outDir = fullfile('C:\EM\BehaviorFitting\CompareFitting_lapseCap');
...
for i_rec = 1:size(unit_table, 1)
    ...
    for i_cue = 1:4
        ...
        plot_psignifit_curve(unit_table.Behave_lapseCap_N{i_rec}{i_cue}, [colorsteps(i_cue,:) 0.5]);
        ...
        plot_psignifit_curve(unit_table.Behave_lapseCap_S{i_rec}{i_cue}, [colorsteps(i_cue,:) 0.5]);
    end
...
for i_rec = 1:size(unit_table, 1)
    for i_cue = 1:4
        DeltaBias(i_rec, i_cue) = unit_table.Behave_lapseCap_N{i_rec}{i_cue}.Fit(1) ...
            - unit_table.Behave_lapseCap_S{i_rec}{i_cue}.Fit(1);
    end
...
for i_rec = 1:size(unit_table, 1)
    for i_cue = 1:4
        ...
        Bias_check(i_rec, i_cue) = unit_table.Behave_lapseCap_N{i_rec}{i_cue}.Fit(1) ...
            - unit_table.Behave_lapseCap_S{i_rec}{i_cue}.Fit(1);
    end
end

...
outDir = fullfile('C:\EM\BehaviorFitting\CompareFitting_lapseHardCap_10');
...
for i_rec = 1:size(unit_table, 1)
    ...
    for i_cue = 1:4
        ...
        plot_psignifit_curve(unit_table.Behave_N{i_rec}{i_cue}, [colorsteps(i_cue,:) 0.5]);
        ...
        plot_psignifit_curve(unit_table.Behave_S{i_rec}{i_cue}, [colorsteps(i_cue,:) 0.5]);
    end

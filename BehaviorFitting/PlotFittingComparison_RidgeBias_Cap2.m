clear;
load('P:\Codes\Matlab\offlineAnalysis\3DMotionAnalysis\Stimulation\John_analysis_try\BehaviorFitting\unit_table_RidgeBias_Cap2.mat')
...
outDir = fullfile('P:\Codes\Matlab\offlineAnalysis\3DMotionAnalysis\Stimulation\John_analysis_try\BehaviorFitting\CompareFitting_RidgeBias_Cap2');
...
for i_rec = 1:size(unit_table, 1)
    ...
    for i_cue = 1:4
        ...
        out = unit_table.Behav_mdl_full_deltaPSEpen_cap2{i_rec}{i_cue};
        b = out.b;

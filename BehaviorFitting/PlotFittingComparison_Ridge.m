...
outDir = fullfile('P:\Codes\Matlab\offlineAnalysis\3DMotionAnalysis\Stimulation\John_analysis_try\BehaviorFitting\CompareFittingRidge');
...
for i_rec = 1:size(unit_table, 1)
    ...
    for i_cue = 1:4
        ...
        b0 = unit_table.Behav_mdl_full_ridgeB1B2B3{i_rec}{i_cue}.b(1);
        b1 = unit_table.Behav_mdl_full_ridgeB1B2B3{i_rec}{i_cue}.b(2);
        b2 = unit_table.Behav_mdl_full_ridgeB1B2B3{i_rec}{i_cue}.b(3);
        b3 = unit_table.Behav_mdl_full_ridgeB1B2B3{i_rec}{i_cue}.b(4);

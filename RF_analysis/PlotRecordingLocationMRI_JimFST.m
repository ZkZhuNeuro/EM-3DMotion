function [h, ML_Index, Depth_Voxel] = PlotRecordingLocationMRI_JimFST(OrigPoint_Voxel, Img_nii, ROI_nii_file, hole, depth, tetrode, ROI_intensity, color_mat, intensity_labels, fig_handle,ML_Offset)
...
%     scatter(ML_Index, Depth_Voxel,15,'go','filled','MarkerEdgeColor','k', 'ButtonDownFcn', @lineCallback);
